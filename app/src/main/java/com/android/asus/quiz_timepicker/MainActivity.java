package com.android.asus.quiz_timepicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    {
        txtDate=(TextView) findViewById(R.id.tv_ngayht);
        txtTime=(TextView) findViewById(R.id.tv_gioht);
        editCv=(EditText) findViewById(R.id.edt_cviec);
        editNd=(EditText) findViewById(R.id.edt_ndung);
        btnDate=(Button) findViewById(R.id.btn_date);
        btnTime=(Button) findViewById(R.id.btn_house);
        btnAdd=(Button) findViewById(R.id.btn_them);
        lvCv=(ListView) findViewById(R.id.lv_ds);
    ...
    {
        btnDate.setOnClickListener((View.OnClickListener) new MyButtonEvent());
        btnTime.setOnClickListener(new MyButtonEvent());
        btnAdd.setOnClickListener(new MyButtonEvent());
        lvCv.setOnItemClickListener((AdapterView.OnItemClickListener) new MyListViewEvent());
        lvCv.setOnItemLongClickListener((AdapterView.OnItemLongClickListener) new MyListViewEvent());
    }
    /**
